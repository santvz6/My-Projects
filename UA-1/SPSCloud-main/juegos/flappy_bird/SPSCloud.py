...
#####################################################################
locate = 6  #0:SPS CLOUD, 1:BIRDY SWORD, 3:SPS HOOT, 5:SPS CLICK
#####################################################################
...
fondo = pygame.image.load('escenario/fondo.png').convert()
menu_birdy = pygame.image.load('escenario/birdy_menu.png').convert()

pajaro = pygame.image.load('jugador/pajaro.png').convert()
pajaro_animado = pygame.transform.scale(pajaro,(pajaro.get_width()- 71,49))

sp_habilidad = pygame.image.load('escenario/obstaculos/mistery_box/box.png').convert() #SPRITE DE MISTERY BOX

logoi = pygame.image.load('spshoot/SPSLogo.png').convert_alpha()
logo = pygame.transform.scale(logoi,(200,200))

menu = pygame.image.load('spshoot/menu.png').convert_alpha()
espacio = pygame.image.load('spshoot/espacio.png').convert()
planetas = pygame.image.load('spshoot/planeta.png').convert_alpha()

mapa5x5 = pygame.image.load('dungeon/baldosas 5x5.png').convert()
mapa5x7 = pygame.image.load('dungeon/baldosas 5x7.png').convert()
mapa7x5 = pygame.image.load('dungeon/baldosas 7x5.png').convert()
mapa7x7 = pygame.image.load('dungeon/baldosas 7x7.png').convert()
menu_dungeon = pygame.image.load('dungeon/menu_dungeon.png').convert()

jugador_dung = [pygame.transform.scale(pygame.image.load('dungeon/JF.png').convert_alpha(),(tam_jugx,tam_jugy)),
    pygame.transform.scale(pygame.image.load('dungeon/JE.png').convert_alpha(),(tam_jugx,tam_jugy)),
    pygame.transform.scale(pygame.image.load('dungeon/JD.png').convert_alpha(),(tam_jugx,tam_jugy)),
    pygame.transform.scale(pygame.image.load('dungeon/JI.png').convert_alpha(),(tam_jugx,tam_jugy))]

enemigo_dung = pygame.transform.scale(pygame.image.load('dungeon/ED.png').convert_alpha(),(tam_enemx,tam_enemy))

mapa_dungeon = [pygame.image.load('dungeon/mazmorras/c0.png').convert(),
                pygame.image.load('dungeon/mazmorras/c1.png').convert(),
                pygame.image.load('dungeon/mazmorras/c2.png').convert(),
                pygame.image.load('dungeon/mazmorras/c3.png').convert(),
                pygame.image.load('dungeon/mazmorras/c4.png').convert()]
                
ed1 = pygame.image.load('dungeon/mazmorras/ed1.png').convert()
ed2 = pygame.image.load('dungeon/mazmorras/ed2.png').convert()
ei1 = pygame.image.load('dungeon/mazmorras/ei1.png').convert()
ei2 = pygame.image.load('dungeon/mazmorras/ei2.png').convert()

pi1 = pygame.image.load('dungeon/mazmorras/pi1.png').convert()
pd1 = pygame.image.load('dungeon/mazmorras/pd1.png').convert()
pa1 = pygame.image.load('dungeon/mazmorras/pa1.png').convert()
pb1 = pygame.image.load('dungeon/mazmorras/pb1.png').convert()

s1 = pygame.image.load('dungeon/mazmorras/s1.png').convert()

pdf1 = pygame.image.load('dungeon/mazmorras/pdf1.png').convert()

good_ending = pygame.image.load('dungeon/good_ending.png').convert()
bad_ending = pygame.image.load('dungeon/bad_ending.png').convert()
...
class JugDungeon(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load('escenario/prueba.png').convert_alpha(),(tam_jugy,tam_jugy))
...
class EnemDungeon(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load('escenario/prueba.png').convert_alpha(),(tam_enemy,tam_enemy))
...
############################################################################################################################
    ...
    ############################# CONVERSOR #############################
        ...
        respuesta = int(input(f'Tu dinero es: {dinero} \n1.BirdySword \n2.SPS Hoot \n3.SPS Click \nRespuesta: '))
...
############################################################################################################################
        ...
        muestra_texto(pantalla,'JUGAR',NEGRO,200,500,'fuentes/m04.TTF',34)
        muestra_texto(pantalla,'JUGAR',col1_birdy,200,500,'fuentes/m04b.TTF',34)

        muestra_texto(pantalla,'SALIR',NEGRO,450,500,'fuentes/m04.TTF',34)
        muestra_texto(pantalla,'SALIR',col2_birdy,450,500,'fuentes/m04b.TTF',34)
...
############################################################################################################################
        ...
        muestra_texto(pantalla,str(puntuacion),VERDE3,47,ALTO-80,'fuentes/Minecraft.ttf',70)
        ...
        muestra_texto(pantalla, str(conteo_animacion/10),NEGRO,360,15,'fuentes/m04.TTF',30)
        muestra_texto(pantalla, str(conteo_animacion/10),BLANCO,360,15,'fuentes/m04b.TTF',30)
...
############################################################################################################################
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button==1: # event.button == 1 : Click derecho
                ...
                if 69 < mouse_pos[0] < 371 and 349 < mouse_pos[1] < 451: # Coordenadas del cuadrado que dibujamos más adelante
                    locate = 0  #Nos devuelve al menú de SPS Cloud
                    conversor = True
        ...
        muestra_texto(pantalla,'PUNTUACION',VERDE3, 450 ,320,'fuentes/m04.TTF',30)
        muestra_texto(pantalla,'PUNTUACION',VERDE2, 450 ,320,'fuentes/m04b.TTF',30)

        muestra_texto(pantalla,str(puntuacion),VERDE3, 570 ,400,'fuentes/m04.TTF',30)
        muestra_texto(pantalla,str(puntuacion),VERDE2, 570 ,400,'fuentes/m04b.TTF',30)
...
################ DIBUJO DE TEXTO, FIGURAS, SPRITES ################
        ...
        muestra_texto(pantalla,pregunta[0], BLANCO, 180, 50, 'fuentes/GSol.ttf',45)
        muestra_texto(pantalla,pregunta[0], NEGRO, 180, 50, 'fuentes/GOut.ttf',45)
        muestra_texto(pantalla,pregunta[1], BLANCO, 200, 100, 'fuentes/GSol.ttf',45)
        muestra_texto(pantalla,pregunta[1], NEGRO, 198.75, 100, 'fuentes/GOut.ttf',45)
        ...
        muestra_texto(pantalla, opciones[0], NEGRO, 140,280,'fuentes/GSha.ttf',40)
        muestra_texto(pantalla, opciones[1], NEGRO, 530,280,'fuentes/GSha.ttf',40)
        muestra_texto(pantalla, opciones[2], NEGRO, 150,475,'fuentes/GSha.ttf',40)
        muestra_texto(pantalla, opciones[3], NEGRO, 530,465,'fuentes/GSha.ttf',40)

        muestra_texto(pantalla, opciones[0], BLANCO, 140,280,'fuentes/GOut.ttf',40)
        muestra_texto(pantalla, opciones[1], BLANCO, 530,280,'fuentes/GOut.ttf',40)
        muestra_texto(pantalla, opciones[2], BLANCO, 150,475,'fuentes/Gout.ttf',40)
        muestra_texto(pantalla, opciones[3], BLANCO, 530,465,'fuentes/GOut.ttf',40)

        ########### TEXTO PUNTAJE ###########
        muestra_texto(pantalla,str(score),NEGRO,382,355,'fuentes/GSha.ttf',45)
        muestra_texto(pantalla,str(score),BLANCO,382,355,'fuentes/GOut.ttf',45)
...
############################################################################################################################
        ...
        muestra_texto(pantalla, str(score_click),color_rgb, 375,330,'fuentes/GSha.ttf',55)
        muestra_texto(pantalla, str(score_click),BLANCO, 375,330,'fuentes/GSol.ttf',55)
        muestra_texto(pantalla, str(score_click),(183,69,206), 371.8,330,'fuentes/GOut.ttf',55)

        muestra_texto(pantalla, 'SPS CLICK',(183,69,206), 275,50,'fuentes/GSha.ttf',65)  
        muestra_texto(pantalla, 'SPS CLICK',color_rgb, 271.8,50,'fuentes/GOut.ttf',65)
        muestra_texto(pantalla, 'SPS CLICK',BLANCO, 275,50,'fuentes/GSol.ttf',65)
          
        muestra_texto(pantalla,'pulsa SPACE',(229,76,224),360,215,'fuentes/GSha.ttf',20)
        muestra_texto(pantalla,'pulsa SPACE',BLANCO,360,215,'fuentes/GSol.ttf',20)

        muestra_texto(pantalla,'haz CLICK',(229,76,224),360,490,'fuentes/GSha.ttf',20)
        muestra_texto(pantalla,'haz CLICK',BLANCO,360,490,'fuentes/GSol.ttf',20)

        muestra_texto(pantalla,'SALIR',(183,69,206),30,20,'fuentes/GSha.ttf',20)
        muestra_texto(pantalla,'SALIR',color_rgb,29.5,20,'fuentes/GOut.ttf',20)
        muestra_texto(pantalla,'SALIR',BLANCO,30,20,'fuentes/GSol.ttf',20)
...
################################################################################################################    
    ...
    ############ OBTENEMOS LA POSICIÓN DEL CURSOR EN CADA MOMENTO ############
        ...
        muestra_texto(pantalla,str(texto_inicio),NEGRO, 373-desplazamiento,170,'fuentes/medieval2.ttf',30) 
        muestra_texto(pantalla,str(texto_inicio),BLANCO, 370-desplazamiento,170,'fuentes/medieval2.ttf',30)
        
        muestra_texto(pantalla,'5',BLANCO,200,210,'fuentes/medieval.ttf',50)
        muestra_texto(pantalla,'7',BLANCO,600,210,'fuentes/medieval.ttf',50)
...
################################################################################################################
    ...
    ################### CARGA DE FONDO DEPENDIENDO DEL MAPA ELEGIDO ###################    
        if tamaño_mapa[0] == 5 and tamaño_mapa[1] == 5:
            pantalla.blit(pygame.image.load('dungeon/fb 5x5.png').convert(),(0,0))
            pantalla.blit(mapa5x5,(100,0))
        elif tamaño_mapa[0] == 5 and tamaño_mapa[1] == 7:
            pantalla.blit(pygame.image.load('dungeon/fb 5x7.png').convert(),(0,0))
            pantalla.blit(mapa5x7,(0,15))
        elif tamaño_mapa[0] == 7 and tamaño_mapa[1] == 5:
            pantalla.blit(pygame.image.load('dungeon/fb 7x5.png').convert(),(13,0))
            pantalla.blit(mapa7x5,(200,0))
        elif tamaño_mapa[0] == 7 and tamaño_mapa[1] == 7:
            pantalla.blit(pygame.image.load('dungeon/fb 7x7.png').convert(),(0,0))
...
#################################################################################################
        ...
        #### DIBUJO DE FLECHS ####
        muestra_texto(superficie_poligono, 'Volver atras',flecha_atr,320,550,'fuentes/medieval2.ttf', 30 )
...
###################################################################################################################
        ...
        muestra_texto(superficie_poligono,'JUGAR',flecha_atr,226,302,'fuentes/medieval2.ttf',35)

        muestra_texto(superficie_poligono,'SALIR',flecha_der,480,302,'fuentes/medieval2.ttf',33) # BOTÓN SALIR
